 ...
 public Help() {
  ...
  JTextArea textArea = new JTextArea(2, 20);
	...
	textArea.setText("Stracheship Presentation\r\n" + 
			...
			"\r\n" + 
			"\r\n" + 
			"Each player has his own round. In this round the player has five available movements . He can choose in every move if he wants to move a ship of his or to hit in a block of the enemy table so as to hit enemy troops."+
			"\r\n" + 
			"\r\n" + 
			"When those five movements end player gets to choose either to give turn in enemy or to use god power . If he chooses god then he picks attack or defense accordingly to his plans."+ 
			"\r\n" + 
			"\r\n" + 
			"When god power ends he has to choose to give turn so he cannot see the table of his enemy. Also, player can win any time. Not all movements must be used.  \r\n" +
			"\r\n" + 
	...
	textArea.setBounds(0, 0, 2500, 2100);
